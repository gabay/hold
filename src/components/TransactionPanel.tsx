...
export default function TransactionPanel({
    ...
    const [prevEditingTransaction, setPrevEditingTransaction] = useState<Transaction | null>(null);
    if (editingTransaction !== prevEditingTransaction) {
        setPrevEditingTransaction(editingTransaction);
